...
<<<<<<< HEAD
        <a href="div_home" <?php if($fileName=='div_home.php') echo "class=active"?>>Home</a>
        <a href="div_home" <?php if($fileName=='#') echo "class=active"?>>Projects</a>
        <a href="div_home" <?php if($fileName=='#') echo "class=active"?>>Reports</a>
        <a href="div_home" <?php if($fileName=='#') echo "class=active"?>>Contractors</a>
        <a href="div_home" <?php if($fileName=='#') echo "class=active"?>>About us</a>       
=======
